<template>
  <header
    ...
    <nav aria-label="Header Navigation"
      ...
      <ul class="flex flex-col items-center space-y-2 md:ml-auto md:flex-row md:space-y-0">
        ...
        <li class="md:mr-12"><a href="/produk">produk</a></li>
        ...
        <div class="order-first col-span-4 max-w-screen-md px-8 py-10 md:order-last md:col-span-2 md:px-10 md:py-12">
          ...
          <form action="">
            <div class="md:col-gap-4 mb-5 grid md:grid-cols-2">
              <input class="col-span-1 w-full border-b py-3 text-sm outline-none focus:border-b-2 focus:border-black"
  ...
  <footer class="relative mt-20 bg-gray-900 px-4 pt-20">
    <div class="absolute -top-10 left-1/2 h-16 w-16 -translate-x-1/2 rounded-x-1 border-4 border-sky-900 bg-white p-2">
      <img class="h-full object-contain"
        src="https://img.freepik.com/free-vector/gradient-car-service-logo-template_23-2149727267.jpg?t=st=1708938280~exp=1708941880~hmac=ee87b21c2a71a8eb222ed70d246b23351929fc1526cf327a052946a6d1fb693a&w=740"
        alt="" />
    </div>
